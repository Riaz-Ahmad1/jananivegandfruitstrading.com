      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h5 mb-0 text-gray-800">New Products</h1>
            <a href="view_services.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-eye fa-sm text-white-50"></i> View Products</a>
          </div>
                ...
                <div class="card-body">
                  <form class="" method="post" name="theform" enctype='multipart/form-data'>
                    ...
                    if (isset($_POST['save_data'])) {
                      ...
                      $scateg = mysqli_real_escape_string($db, $_POST['scateg']);
                      ...
                      $query = "INSERT INTO services(sname,simage,scateg,price)VALUES('$sname','$simage','$scateg','$price')";
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="inputEmail4" class="formlabel">Select Category <span class="text-danger"> * </span> </label>
                           <select name="scateg" id=""class="form-control form-control-sm">
