      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h5 mb-0 text-gray-800">View Testimonial</h1>
            <a href="view_testimonial.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-eye fa-sm text-white-50"></i> View Testimonial</a>
          </div>
                ...
                <div class="card-body">
                  <form class="" method="post" name="theform" enctype='multipart/form-data'>
                    ...
                    if (isset($_POST['save_data'])) {
                      ...
                      $query = "INSERT INTO testimonial(name,profession,pic,comment)VALUES('$name','$profession','$pic','$comment')";
                      ...
                      if ($result) {
                        echo '
                                             ...
                                             ';
                        header('Refresh:1,url=testimonial.php');
                      } else {
                        echo '
                    ...
                    <div class="row">
                    <textarea name="comment" id="comment" class="w-100 form-control mb-4 p-3 border-primary bg-light" rows="4" cols="10" placeholder="Your Message"></textarea>
