...
================================================== -->
  <meta charset="utf-8">
  <title>Dubai Fast Movers| Our Team</title>
        ...
        <div class="container h-50">
          <div class="row align-items-center h-100">
              <div class="col-md-12 text-center">
                <h3 class="slide-sub-title text-primary" data-animation-in="slideInRight">OUR <span class="text-white" >TEAM</span> </h3>
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 mb-5">
        <div class="ts-team-wrapper">
          <div class="team-img-wrapper">
            <img loading="lazy" src="uploads/team/<?php echo $picture ?>" class="img-fluid" alt="team-img">
          </div>
          <div class="ts-team-content-classic">
            <h3 class="ts-name"><?php echo $name ?></h3>
            <p class="ts-designation"><?php echo $designation ?></p>
